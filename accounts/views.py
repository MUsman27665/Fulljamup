...
class ProfileUpdateView(UpdateView):
    model = UserProfile
    fields = ['first_name','last_name','username','datetimepicker','p_photo','h_photo','subtitles',
            'about_me','birthplace','lives_in','country','province','city','occupation','website',
